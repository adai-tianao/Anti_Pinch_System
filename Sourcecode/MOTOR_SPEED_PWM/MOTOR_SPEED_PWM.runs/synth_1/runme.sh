...
HD_PWD='E:/XILINX/savefiles/anti_pinch/MOTOR_SPEED_PWM/MOTOR_SPEED_PWM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MOTOR_SPEED_PWM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MOTOR_SPEED_PWM.tcl
