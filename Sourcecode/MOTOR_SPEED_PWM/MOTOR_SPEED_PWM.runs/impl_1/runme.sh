...
HD_PWD='E:/XILINX/savefiles/anti_pinch/MOTOR_SPEED_PWM/MOTOR_SPEED_PWM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MOTOR_SPEED_PWM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MOTOR_SPEED_PWM.tcl -notrace
