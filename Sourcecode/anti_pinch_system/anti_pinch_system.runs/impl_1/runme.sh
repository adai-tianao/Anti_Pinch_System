...
HD_PWD='E:/XILINX/savefiles/anti_pinch/anti_pinch_system/anti_pinch_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log anti_pinch_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source anti_pinch_top.tcl -notrace
