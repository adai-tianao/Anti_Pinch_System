...
HD_PWD='E:/XILINX/savefiles/anti_pinch/anti_pinch_system/anti_pinch_system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log anti_pinch_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source anti_pinch_top.tcl
